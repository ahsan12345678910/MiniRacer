/**
 * Straight Track Renderer
 * 
 * Renders a simple straight track with no curves
 */

import React from 'react';
import { View, StyleSheet } from 'react-native';
import { StraightTrack, StraightTrackSegment } from './StraightTrackDesign';

interface StraightTrackRendererProps {
  track: StraightTrack;
  cameraX: number;
  cameraY: number;
  screenWidth: number;
...
export const StraightTrackRenderer: React.FC<StraightTrackRendererProps> = ({
  track,
  cameraX,
  cameraY,
  screenWidth,
  ...
  const isSegmentVisible = (segment: StraightTrackSegment) => {
  ...
  const getSegmentStyle = (segment: StraightTrackSegment) => {
    const baseStyle = {
...
export default StraightTrackRenderer;
